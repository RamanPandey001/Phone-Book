...
def load_gui(app):
    ...
    # DELETE button
    app.btn_delete_person = tk.Button(
        app.action_frame, text="DELETE", command=lambda: contactlist_func.delete_person(app),
        relief=GROOVE, bg='#dcdcdc')
    ...
    app.contactlist_box = tk.Listbox(app.container, exportselection=0,
                                     yscrollcommand=sb.set, width=28, selectmode=SINGLE)
